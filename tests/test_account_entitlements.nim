...
suite "account_entitlements serialization":
...
suite "account_entitlements endpoints":
  test "GET /accounts/{account_id}/entitlements":
    let client = initCloudflareClient("test-key")
    client.baseUri = "http://127.0.0.1:" & $int(startMock())
    discard waitFor client.getAccountsAccountIdEntitlements("test")
