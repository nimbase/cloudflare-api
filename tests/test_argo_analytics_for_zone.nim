...
suite "argo_analytics_for_zone serialization":
...
suite "argo_analytics_for_zone endpoints":
  test "GET /zones/{zone_id}/analytics/latency":
    let client = initCloudflareClient("test-key")
    client.baseUri = "http://127.0.0.1:" & $int(startMock())
    discard waitFor client.getZonesZoneIdAnalyticsLatency("test", "test")
