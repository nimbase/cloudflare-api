...
suite "dns_analytics serialization":
...
suite "dns_analytics endpoints":
  test "GET /zones/{zone_id}/dns_analytics/report":
    let client = initCloudflareClient("test-key")
    client.baseUri = "http://127.0.0.1:" & $int(startMock())
    discard waitFor client.getZonesZoneIdDnsAnalyticsReport("test", "test", "test", "test", "test", 1, "test", "test")
