...
proc getAccountsAccountIdDataSecurityPostureFindings*(client: CloudflareClient,
                                                      ...
                                                      direction: FindingDirectionOption = directionAsc,
                                                      ...
                                                      observation: FindingObservationOption = observationActivity,
                                                      order: FindingOrderOption = orderFindingName,
                                                      page: int64 = default(int64),
                                                      perPage: int64 = default(int64),
                                                      product: FindingProductOption = productCloud,
                                                      search: string = default(string),
                                                      severity: FindingSeverityOption = severityCritical,
                                                      `type`: FindingTypeOption = typeContent,
